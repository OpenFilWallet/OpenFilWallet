<template>
    <div class="transfer-page">
        <h1 class="title">Msig Transfer FIL Propose</h1>
...
import { msigTransfer } from "@/api/openfil/msig.js";
export default {
    data() {
        return {
            msigWallets: [],
    ...
    methods: {
        ...
        submit() {
            this.$refs.form.validate(valid => {
                if (valid) {
                    this.loading = true;
                    msigTransfer(this.form.from, this.form.msig, this.form.to, this.form.amount.toString()).then(response => {
