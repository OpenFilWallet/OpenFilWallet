...
func (m *Msiger) NewMsigCreateMessage(baseParams BaseParams, required, duration uint64, value, from string, signers ...string) (*types.Message, *multisig12.ConstructorParams, error) {
...
func (m *Msiger) NewMsigApproveMessage(baseParams BaseParams, msigAddress, txId string, from string) (*types.Message, *multisig12.TxnIDParams, error) {
...
func (m *Msiger) NewMsigCancelMessage(baseParams BaseParams, msigAddress, txId string, from string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigTransferProposeMessage(baseParams BaseParams, msigAddress, destinationAddress, amount string, from string) (*types.Message, *multisig12.ProposeParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigTransferApproveMessage(baseParams BaseParams, msigAddress, txId string, from string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigTransferCancelMessage(baseParams BaseParams, msigAddress, txId string, from string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigAddSignerProposeMessage(baseParams BaseParams, msigAddress, signerAddress string, increaseThreshold bool, from string) (*types.Message, *multisig12.ProposeParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigAddSignerApproveMessage(baseParams BaseParams, msigAddress, proposerAddress, txId, signerAddress string, increaseThreshold bool, from string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigAddSignerCancelMessage(baseParams BaseParams, msigAddress, txId, signerAddress string, increaseThreshold bool, from string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigSwapProposeMessage(baseParams BaseParams, msigAddress, oldAddress, newAddress string, from string) (*types.Message, *multisig12.ProposeParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigSwapApproveMessage(baseParams BaseParams, msigAddress, proposerAddress, txId, oldAddress, newAddress string, from string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigSwapCancelMessage(baseParams BaseParams, msigAddress, txId, oldAddress, newAddress string, from string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigLockProposeMessage(baseParams BaseParams, msigAddress, startEpoch, unlockDuration, amount string, from string) (*types.Message, *multisig12.ProposeParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
	...
	params, actErr := actors.SerializeParams(&multisig12.LockBalanceParams{
...
func (m *Msiger) NewMsigLockApproveMessage(baseParams BaseParams, msigAddress, proposerAddress, txId, startEpoch, unlockDuration, amount string, from string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigLockCancelMessage(baseParams BaseParams, msigAddress, txId, startEpoch, unlockDuration, amount string, from string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigThresholdProposeMessage(baseParams BaseParams, msigAddress, newThreshold string, from string) (*types.Message, *multisig12.ProposeParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
	...
	params, actErr := actors.SerializeParams(&multisig12.ChangeNumApprovalsThresholdParams{
		NewThreshold: newT,
	})
...
func (m *Msiger) NewMsigThresholdApproveMessage(baseParams BaseParams, msigAddress, proposerAddress, txId, newThreshold string, from string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigThresholdCancelMessage(baseParams BaseParams, msigAddress, txId, newThreshold string, from string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigChangeOwnerProposeMessage(baseParams BaseParams, msigAddress, miner, newOwner string, from string) (*types.Message, *multisig12.ProposeParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigChangeOwnerApproveMessage(baseParams BaseParams, msigAddress, proposerAddress, txId, miner, newOwner string, from string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigWithdrawProposeMessage(baseParams BaseParams, msigAddress, miner, amount string, from string) (*types.Message, *multisig12.ProposeParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigWithdrawApproveMessage(baseParams BaseParams, msigAddress, proposerAddress, txId, miner, amount string, from string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigChangeWorkerProposeMessage(baseParams BaseParams, msigAddress, miner, newWorker string, from string) (*types.Message, *multisig12.ProposeParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigChangeWorkerApproveMessage(baseParams BaseParams, msigAddress, proposerAddress, txId, miner, newWorker string, from string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigConfirmChangeWorkerProposeMessage(baseParams BaseParams, msigAddress, miner, newWorker string, from string) (*types.Message, *multisig12.ProposeParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigConfirmChangeWorkerApproveMessage(baseParams BaseParams, msigAddress, proposerAddress, txId, miner, newWorker string, from string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigSetControlProposeMessage(baseParams BaseParams, msigAddress, miner string, from string, controlAddrs ...string) (*types.Message, *multisig12.ProposeParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigSetControlApproveMessage(baseParams BaseParams, msigAddress, proposerAddress, txId, miner string, from string, controlAddrs ...string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigChangeBeneficiaryProposeMessage(baseParams BaseParams, msigAddress, minerId string, from string, beneficiaryAddress, quota, expiration string, overwritePendingChange bool) (*types.Message, *multisig12.ProposeParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigChangeBeneficiaryApproveMessage(baseParams BaseParams, msigAddress, proposerAddress, txId, minerId string, from string, beneficiaryAddress, quota, expiration string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigConfirmChangeBeneficiaryProposeMessage(baseParams BaseParams, msigAddress, minerId string, from string) (*types.Message, *multisig12.ProposeParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) NewMsigConfirmChangeBeneficiaryApproveMessage(baseParams BaseParams, msigAddress, minerId, proposerAddress, txId, from string) (*types.Message, *multisig12.TxnIDParams, error) {
	msig, err := address.NewFromString(msigAddress)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) MsigCreate(req uint64, addrs []address.Address, duration abi.ChainEpoch, val types.BigInt, src address.Address) (*types.Message, *multisig12.ConstructorParams, error) {
...
func (m *Msiger) MsigPropose(msig address.Address, to address.Address, amt types.BigInt, src address.Address, method uint64, params []byte) (*types.Message, *multisig12.ProposeParams, error) {
	mb, err := m.messageBuilder(src)
	if err != nil {
		return nil, nil, err
	}
...
func (m *Msiger) MsigAddPropose(msig address.Address, src address.Address, newAdd address.Address, inc bool) (*types.Message, *multisig12.ProposeParams, error) {
...
func (m *Msiger) MsigAddApprove(msig address.Address, src address.Address, txID uint64, proposer address.Address, newAdd address.Address, inc bool) (*types.Message, *multisig12.TxnIDParams, error) {
	enc, actErr := serializeAddParams(newAdd, inc)
	if actErr != nil {
		return nil, nil, actErr
	}
...
func (m *Msiger) MsigAddCancel(msig address.Address, src address.Address, txID uint64, newAdd address.Address, inc bool) (*types.Message, *multisig12.TxnIDParams, error) {
	enc, actErr := serializeAddParams(newAdd, inc)
	if actErr != nil {
		return nil, nil, actErr
	}
...
func (m *Msiger) MsigSwapPropose(msig address.Address, src address.Address, oldAdd address.Address, newAdd address.Address) (*types.Message, *multisig12.ProposeParams, error) {
...
func (m *Msiger) MsigSwapApprove(msig address.Address, src address.Address, txID uint64, proposer address.Address, oldAdd address.Address, newAdd address.Address) (*types.Message, *multisig12.TxnIDParams, error) {
	enc, actErr := serializeSwapParams(oldAdd, newAdd)
	if actErr != nil {
		return nil, nil, actErr
	}
...
func (m *Msiger) MsigSwapCancel(msig address.Address, src address.Address, txID uint64, oldAdd address.Address, newAdd address.Address) (*types.Message, *multisig12.TxnIDParams, error) {
	enc, actErr := serializeSwapParams(oldAdd, newAdd)
	if actErr != nil {
		return nil, nil, actErr
	}
...
func (m *Msiger) MsigApprove(msig address.Address, txID uint64, src address.Address) (*types.Message, *multisig12.TxnIDParams, error) {

	return m.MsigApproveOrCancelSimple(api.MsigApprove, msig, txID, src)
}

func (m *Msiger) MsigApproveTxnHash(msig address.Address, txID uint64, proposer address.Address, to address.Address, amt types.BigInt, src address.Address, method uint64, params []byte) (*types.Message, *multisig12.TxnIDParams, error) {
	return m.MsigApproveOrCancelTxnHash(api.MsigApprove, msig, txID, proposer, to, amt, src, method, params)
}

func (m *Msiger) MsigCancel(msig address.Address, txID uint64, src address.Address) (*types.Message, *multisig12.TxnIDParams, error) {
	return m.MsigApproveOrCancelSimple(api.MsigCancel, msig, txID, src)
}

func (m *Msiger) MsigCancelTxnHash(msig address.Address, txID uint64, to address.Address, amt types.BigInt, src address.Address, method uint64, params []byte) (*types.Message, *multisig12.TxnIDParams, error) {
	return m.MsigApproveOrCancelTxnHash(api.MsigCancel, msig, txID, src, to, amt, src, method, params)
}

func (m *Msiger) MsigRemoveSigner(msig address.Address, proposer address.Address, toRemove address.Address, decrease bool) (*types.Message, *multisig12.ProposeParams, error) {
...
func (m *Msiger) MsigApproveOrCancelSimple(operation api.MsigProposeResponse, msig address.Address, txID uint64, src address.Address) (*types.Message, *multisig12.TxnIDParams, error) {
...
func (m *Msiger) MsigApproveOrCancelTxnHash(operation api.MsigProposeResponse, msig address.Address, txID uint64, proposer address.Address, to address.Address, amt types.BigInt, src address.Address, method uint64, params []byte) (*types.Message, *multisig12.TxnIDParams, error) {
	if msig == address.Undef {
		return nil, nil, xerrors.Errorf("must provide multisig address")
	}
...
func serializeAddParams(new address.Address, inc bool) ([]byte, error) {
	enc, actErr := actors.SerializeParams(&multisig12.AddSignerParams{
		Signer:   new,
		Increase: inc,
	})
	if actErr != nil {
...
func serializeSwapParams(old address.Address, new address.Address) ([]byte, error) {
	enc, actErr := actors.SerializeParams(&multisig12.SwapSignerParams{
		From: old,
		To:   new,
	})
	if actErr != nil {
...
func serializeRemoveParams(rem address.Address, dec bool) ([]byte, error) {
	enc, actErr := actors.SerializeParams(&multisig12.RemoveSignerParams{
		Signer:   rem,
		Decrease: dec,
	})
	if actErr != nil {
...
func txnParams(id uint64, data *multisig12.ProposalHashData) (*multisig12.TxnIDParams, error) {
	params := multisig12.TxnIDParams{ID: multisig12.TxnID(id)}
	if data != nil {
